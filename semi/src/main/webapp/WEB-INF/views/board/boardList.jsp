	...
	<div class="container my-5">
									...
									<td class="boardTitle">
										...
										<c:choose>
											<c:when test="${board.boardStatusName == '블라인드'}">
												<strong style="color:lightgrey; font-size:15px;">관리자에 의해 숨김처리 된 게시글입니다.</strong>
											</c:when>
		...
		<div class="my-5">
			...
			<c:if test="${pagination.startPage != 1}">
				<li>
					<a class="page-link" href="list?cp=1">&lt;&lt;</a>
				</li>
				<li>
					<a class="page-link" href="list?cp=${pagination.prevPage}">&lt;</a>
				</li>
			</c:if>
			...
			<c:forEach begin="${pagination.startPage}" end="${pagination.endPage}" step="1" var="i">
				<c:choose>
					<c:when test="${i==pagination.currentPage}">
						<li><a class="page-link" style="font-weight: bold">${i}</a></li>
					</c:when>
			...
			<li>
				<a class="page-link" href="list?cp=${pagination.nextPage}">&gt;</a>
			</li>
			<li>
				<a class="page-link" href="list?cp=${pagination.endPage}">&gt;&gt;</a>
			</li>
			</c:if>
			</ul>
		</div>
